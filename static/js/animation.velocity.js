...
(function (root, factory) {
  ...
  ScrollMagic.Scene.extend(function () {
    var
      ...
      _properties,
      _options,
      _dataID; // used to identify element data related to this scene, will be defined everytime a new velocity
               // animation is added
     ...
     *
     * @param {(object|string)} elems - One or more Dom Elements or a Selector that should be used as the target of the
     *   animation.
    ...
    Scene.setVelocity = function (elems, properties, options) {
      ...
      if (_options.queue !== undefined) {
        ...
        // defining anything other than 'false' as the que doesn't make much sense, because ScrollMagic takes control
        // over the trigger. thus it is also overwritten.
     ...
     *
     * Using the reset option you can decide if the animation should remain in the current state or be rewound to set
     * the target elements back to the state they were in before the animation was added to the scene.
     * @memberof! animation.Velocity#
     *
     * @example
